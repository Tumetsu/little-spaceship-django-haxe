...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rocket.distanceToTarget'
        db.add_column(u'spaceAPI_rocket', 'distanceToTarget',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rocket.distanceToTarget'
        db.delete_column(u'spaceAPI_rocket', 'distanceToTarget')
