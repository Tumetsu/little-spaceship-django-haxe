...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CelestialObjectModel'
        db.create_table(u'spaceAPI_celestialobjectmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('distanceFromSun', self.gf('django.db.models.fields.FloatField')(max_length=200)),
        ))
        db.send_create_signal(u'spaceAPI', ['CelestialObjectModel'])


    def backwards(self, orm):
        # Deleting model 'CelestialObjectModel'
        db.delete_table(u'spaceAPI_celestialobjectmodel')


    models = {
        u'spaceAPI.celestialobjectmodel': {
            'Meta': {'object_name': 'CelestialObjectModel'},
            'distanceFromSun': ('django.db.models.fields.FloatField', [], {'max_length': '200'}),
