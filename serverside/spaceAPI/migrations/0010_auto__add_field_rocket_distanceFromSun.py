...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rocket.distanceFromSun'
        db.add_column(u'spaceAPI_rocket', 'distanceFromSun',
                      self.gf('django.db.models.fields.FloatField')(default=149600000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rocket.distanceFromSun'
        db.delete_column(u'spaceAPI_rocket', 'distanceFromSun')
